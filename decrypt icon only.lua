...
"[️✔️]ＹＥＳ",
"[❌]ＮＯ"
}, nil, "For use this Version without problem, your must have fix patch!\nAre you already move the fix?")
if menusec == nil then else
if menusec == 1 then goto START end
if menusec == 2 then goto yaya end
end
os.exit()

::START::
menu = gg.choice ({'[1️⃣]Ｒａｄａｒ 太陽','[2️⃣]Ｄｒｏｎｅ 太陽','[⏳]Ｅｘｐｉｒｅｄ チメ','[⚠️]Ｃｒｅｄｉｔ','[⛔]Ｅｘｉｔ'}, nill, "The version you have is Taiyou Project Script v1.2understable0504190931icononly")
